...
public:
    ...
    virtual void cartoon_prnt() { cout << "Название мультфильма " << name << endl; }
};
...
public:
    ...
    void desc_prnt()
    {
        ...
        cout << "Студия, выпущенная мультфильм " << studio << " количество сезонов " << sesion << endl;
    }
};
